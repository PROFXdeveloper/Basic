...
while running:
    ...
    for theta in range(
        ...
        for phi in range(
            ...
            x = circlex * (cosB * cosphi +
                           sinA * sinB * sinphi) - circley * cosA * sinB
            y = circlex * (sinB * cosphi -
                           sinA * cosB * sinphi) + circley * cosA * cosB
            ...
            if ooz > zbuffer[position]:
                ...
                output[position] = chars[
                    luminance_index if luminance_index > 0 else 0]
